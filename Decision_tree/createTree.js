...
/*
  ...
  Если в оставшихся атрибутах остается ровно один элемент, мы форсируем его использование —
  тем самым гарантируя, что даже предпоследний столбец (если последний – целевой) не будет пропущен.
*/
